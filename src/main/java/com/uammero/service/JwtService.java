...
import com.uammero.jwt.util.JwtUtil;
...
public class JwtService implements UserDetailsService {
    ...
    public ResponseJwt createJwtToken(RequestJwt jwtRequest) throws Exception {
        ...
        return new ResponseJwt(user, newGeneratedToken);
    }
